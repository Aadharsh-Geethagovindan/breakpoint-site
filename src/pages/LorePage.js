...
export default function LorePage() {
  ...
  return (
    <div style={{ display: 'flex' }}>
      <LoreSidebar activeSectionId={sectionId} subheadings={subheadings} activeHeading={activeHeading} />
      <div style={{ flex: 1, padding: '20px' }}>
        <LoreSection sectionId={sectionId} onHeadingsExtracted={setSubheadings} setActiveHeading={setActiveHeading} />
